...
echo ""
echo "Next steps:"
echo "1. Edit config/model_paths.yaml with your model path"
echo "2. Copy batch results if not already done:"
echo "   rsync -avz local:Metadata-Curation/omics-extractor/riboseq_batch_output/*.json riboseq_batch_output/"
echo "3. Test in interactive session:"
echo "   srun --partition=gpu --gres=gpu:1 --cpus-per-task=4 --mem=32G --time=02:00:00 --pty bash"
echo ""
